...
if TYPE_CHECKING:
    from ..models.bots_control import BotsControl


T = TypeVar("T", bound="PaginatedBotsControlList")


@_attrs_define
class PaginatedBotsControlList:
    """
    Attributes:
        ...
        results (Union[Unset, List['BotsControl']]):
    """
    ...
    results: Union[Unset, List["BotsControl"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for results_item_data in _results or []:
            results_item = BotsControl.from_dict(results_item_data)

            results.append(results_item)

        paginated_bots_control_list = cls(
            page_size=page_size,
        ...
        paginated_bots_control_list.additional_properties = d
        return paginated_bots_control_list
