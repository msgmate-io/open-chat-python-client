...
class PatchedUserProfile:
    ...
    def to_multipart(self) -> Dict[str, Any]:
        ...
        last_updated: Union[Unset, bytes] = UNSET
        if not isinstance(self.last_updated, Unset):
            last_updated = self.last_updated.isoformat().encode()
        ...
        is_bot = self.is_bot if isinstance(self.is_bot, Unset) else (None, str(self.is_bot).encode(), "text/plain")
        ...
        reqires_contact_password = (
            self.reqires_contact_password
            if isinstance(self.reqires_contact_password, Unset)
            else (None, str(self.reqires_contact_password).encode(), "text/plain")
        )
